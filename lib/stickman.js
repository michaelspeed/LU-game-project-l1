export default class StickMan {
  ...
  renderWalkLeft(x, y, color) {
    ...
    // arms
    const shoulderY = headY + headRadius + neckLength;
    line(headX, shoulderY, headX - armWidth - this.walkDelta, shoulderY + armHeight - this.walkDelta);
    line(headX, shoulderY, headX + armWidth, shoulderY + armHeight);

    // legs
    const legY = headY + headRadius + bodyHeight;
    line(headX, legY, headX - legWidth - this.walkDelta, legY + legHeight);
    line(headX, legY, headX + legWidth, legY + legHeight);
    pop();
  }
  ...
  renderWalkRight(x, y, color) {
    ...
    const shoulderY = headY + headRadius + neckLength;
    line(headX, shoulderY, headX - armWidth, shoulderY + armHeight);
    line(headX, shoulderY, headX + armWidth + this.walkDelta, shoulderY + armHeight);
  ...
  renderJumpToRight(x, y, color) {
    ...
    // arms
    const shoulderY = headY + headRadius + neckLength;
    line(headX, shoulderY, headX - armWidth - this.jumpDelta, shoulderY + armHeight - this.jumpDelta);
    line(headX, shoulderY, headX + armWidth, shoulderY + armHeight);

    // legs
    const legY = headY + headRadius + bodyHeight;
    line(headX, legY, headX - legWidth - this.jumpDelta + this.walkDelta, legY + legHeight - this.jumpDelta - this.walkDelta);
    line(headX, legY, headX + legWidth + this.jumpDelta - this.walkDelta, legY + legHeight - this.jumpDelta + this.walkDelta);
    pop();
  }
  ...
  renderJumpToLeft(x, y, color) {
    ...
    // legs
    const legY = headY + headRadius + bodyHeight;
    line(headX, legY, headX - legWidth - this.walkDelta , legY + legHeight - this.walkDelta);
    line(headX, legY, headX + legWidth + this.jumpDelta - this.walkDelta, legY + legHeight - this.jumpDelta - this.walkDelta);
    pop();
  }
}
